        ...
        <div className="grid gap-6 md:grid-cols-2">
          {promotions.map((promo, index) => (
            <FadeUp
              ...
              distance={40}
            >
              <article className="group rounded-2xl border border-[#003D78]/30 bg-white p-8 transition-all duration-300 hover:-translate-y-2 hover:border-[#003D78] hover:shadow-xl">
